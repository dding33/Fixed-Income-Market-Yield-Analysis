...
\usepackage{amsmath, tikz, amsfonts, bbm, mathrsfs, graphicx, amssymb, amsthm, hyperref, centernot, enumerate, bbm, xcolor, lmodern, mathdots, amsfonts, graphicx,float,subfig}
\graphicspath{ {./output/} }
...
\begin{figure}%
    \centering
    \subfloat{{\includegraphics[width=5cm]{YTM.png}}}%
    \qquad
    \subfloat{{\includegraphics[width=5cm]{SPOT.png}}}%
    \caption{Q4(a) and (b)}%
    \label{fig:4ab}%
\end{figure}         
            \begin{figure}[hbt!]
